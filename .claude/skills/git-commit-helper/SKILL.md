...
- **Project note (profil)**: This repository is a global open-source project. This English-only rule is non-negotiable here regardless of what language the assistant is otherwise chatting in — it applies to commit messages, source code, and code comments alike. Never localize any of these to Korean or any other language.
